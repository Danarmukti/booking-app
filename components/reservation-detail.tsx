...
const ReservationDetail = async ({
  ...
  return (
    <div className="w-full p-4 bg-white bodrder border-gray-200 rounded-sm shadow">
        ...
        <ul>
          ...
          <li className="py-2">
            <div className="flex items-center">
              ...
              <div className="capitalize inline-flex items-center text-base font-semibold text-gray-900">
