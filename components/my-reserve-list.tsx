        ...
        >
          ...
          <div className="flex flex-col mb-4 items-start  bg-white rounded-sm md:flex-row md:w-full">
            <Image
              ...
              alt="image room"
            />
            <div className="p-2 w-full flex items-center gap-1 mb-3 font-normal text-gray-700">
          ...
          <div className="flex items-end justify-end absolute inset-4">
            {item.Payment?.status === "unpaid" ? (
              <Link
                ...
                className="px-6 py-1 text-white transition-all duration-150 bg-blue-500 hover:bg-blue-600 rounded-md"
              >
                Pay Now
              </Link>
            ) : (
              <Link
                ...
                className="px-6 py-1 bg-blue-500 text-white transition-all duration-150 hover:bg-blue-600 rounded-md"
              >
                View Detail
              </Link>
            )}
