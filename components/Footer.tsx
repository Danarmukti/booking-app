  ...
  return (
    <footer className="bg-gray-900">
        ...
        <div className="grid md:grid-cols-3 gap-7">
          <div>
            ...
            <p className="text-gray-400">
              ...
              Inventore, perspiciatis harum magni illo, molestiae magnam
              dignissimos ipsam ducimus porro ipsa at voluptate error maxime
              ipsum in voluptatem earum officiis fuga?
            </p>
          </div>
          <div>
      ...
      <div className="max-w-screen-xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base text-gray-500">
        &copy; Copyright 2025 | DanarCode | All Right Reserved
      </div>
    </footer>
  );
};
