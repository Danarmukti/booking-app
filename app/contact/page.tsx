        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-gray-700 py-5">
              ...
              perferendis consequatur sunt assumenda explicabo doloribus.
            </p>
            <ul className="list-item space-y-6 pt-8">
              ...
              <li className="flex gap-5">
                ...
                <div className="flex-1">
                  <h4 className="text-lg font-semibold mb-1">No Telp :</h4>
                  <p>+62 893 04309 4432</p>
                </div>
              </li>
              <li className="flex gap-5">
                <div className="flex-none bg-gray-300 p-3 shadow-sm rounded-sm">
                ...
                <div className="flex-1">
                  ...
                  <p>Jl Malaka, DKI Jakarta, Indonesia</p>
                </div>
              </li>
            </ul>
          </div>
